  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-white my-10 text-sm sm:text-lg lg:text-xl font-semibold tracking-tight text-center">
          It's all PUBLIC data so don't share something confidential.
        </h1>
